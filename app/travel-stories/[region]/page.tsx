      ...
      <div className="min-h-screen bg-white">
        ...
        <main className="pt-24 pb-16">
          <div className="max-w-4xl mx-auto px-4 text-center">
            ...
            <Link href="/travel-stories" className="text-amber-600 hover:text-amber-700">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <Breadcrumbs
            items={[
              ...
              { label: regionData.title, href: `/travel-stories/${params.region}` },
            ]}
          />
          ...
          <div className="space-y-12">
            {regionData.stories.map((story: any) => (
              <article key={story.id} className="group">
                <Link href={`/travel-stories/${params.region}/${story.slug}`}>
